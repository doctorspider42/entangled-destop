...
pub use device::{
    DeferredWaker, DeviceError, DeviceResources, DeviceType, HostWaker, ShmAccessError, ShmBacking,
    ShmMapError, ShmRegion, VirtioDevice,
};
pub use interrupt::{
...
pub use save::{
    InterruptState, MsixEntryState, MsixState, QueuePosition, QueueState, StateError,
    TransportSaveState,
};
