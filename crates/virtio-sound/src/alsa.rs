//! The Linux playback sink: ALSA, `dlopen`ed at runtime.
//!
...
/// The nine entry points this sink needs, resolved up front so an ALSA too old
/// to have one of them fails at load rather than mid-stream.
struct Api {
...
mod tests {
    ...
    /// a failure. When the library *is* there, this proves the nine symbols
